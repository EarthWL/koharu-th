...
|---|---|
| **OpenAI** (หรือ compatible) | API Key · ชื่อโมเดล (เช่น `gpt-4o`, `gpt-4o-mini`) · Base URL (default `https://api.openai.com/v1` เปลี่ยนได้เป็น OpenRouter, Together, local llama.cpp / vLLM server ฯลฯ) |
