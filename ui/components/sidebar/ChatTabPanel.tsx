              ...
              groupChatRows(history.data).map((g) =>
                g.type === 'message' ? (
                  (() => {
                    ...
                    if (g.message.role === 'assistant' && history.data) {
                      const idx = history.data.findIndex((m) => m.id === g.message.id)
                      if (idx !== -1) {
                    ...
                    return (
                      <MessageRow
                        ...
                        onUndoFromHere={() => void revokeFromMessage(g.message)}
                        onRegenerate={
                          g.message.role === 'assistant'
                            ? () => void regenerateFromMessage(g.message)
                            : undefined
                        }
